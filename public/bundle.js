			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'h2',
							{ className: 'text-center', style: { 'color': 'white', 'textShadow': '1px 1px 5px #ccc', 'fontSize': '40px' } },
							'Looking for a New York Times article?'
						),
						React.createElement(
							'p',
							{ className: 'text-center', style: { 'color': 'white', 'textShadow': '1px 1px 5px #ccc', 'fontSize': '20px' } },
							'Search for one and save it for later!'
						)
					)
				),
				React.createElement(
	...
	var Form = React.createClass({
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'panel-heading', style: panelStyle },
					React.createElement(
						'h2',
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'button',
								{ type: 'button', className: 'btn', onClick: this.handleClick },
								'Search'
							)
						)
					)
	...
	var Results = React.createClass({
		...
		componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
			...
			var myResults = nextProps.results.map(function (search, i) {
				...
				return React.createElement(
					'div',
					{ className: 'list-group-item row', key: i },
					React.createElement(
						'div',
						{ className: 'col-md-9' },
						React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'button',
							{ type: 'button', className: 'btn', style: {}, onClick: boundClick },
							'Save'
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// New York Times API
	var nytAPI = "9e6b6ca945f84fe9b17255ac2686f15b";
